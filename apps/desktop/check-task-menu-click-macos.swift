...
Thread.sleep(forTimeInterval:0.8)
print("active_after_click=\(app.isActive) visible_menu=\(visibleWindow() != nil)")
...
let report:[String:Any]=["pid":Int(app.processIdentifier),"window_id":id,"pet_mouse_click_opens_menu":true,"inactive_before_click":inactive,"real_empty_state":true,"close_hides":true,"tray_restores_same_window":true,"passed":true]
