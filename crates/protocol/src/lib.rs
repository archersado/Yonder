...
#[derive(Clone, Copy, Debug, PartialEq, Serialize, Deserialize, JsonSchema, TS)]
pub enum Capability { #[serde(rename = "task.read")] TaskRead, #[serde(rename = "task.create")] TaskCreate, #[serde(rename = "task.cancel")] TaskCancel, #[serde(rename = "task.complete")] TaskComplete, #[serde(rename = "task.fail")] TaskFail, #[serde(rename = "task.control")] TaskControl, #[serde(rename = "task.wait-for-user")] TaskWaitForUser, #[serde(rename = "task.step.declare")] TaskStepDeclare, #[serde(rename = "task.step.advance")] TaskStepAdvance, #[serde(rename = "browser.execute")] BrowserExecute, #[serde(rename = "computer.execute")] ComputerExecute }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, JsonSchema, TS)]
#[serde(deny_unknown_fields)]
pub struct AgentInputResult { pub accepted: bool }

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, JsonSchema, TS)]
#[serde(untagged, deny_unknown_fields)]
pub enum AgentResponse {
    Success { jsonrpc: Version, id: String, result: AgentInputResult },
...
pub struct WaitForUserParams {
    pub agent_id: String, pub capability: Capability,
    #[ts(type = "number")]
    #[schemars(range(min = 0, max = 9007199254740991_u64))]
    pub deadline: u64,
    pub task_id: String, pub expected_sequence: String, pub reason: String,
}
...
pub struct ControlParams {
    ...
    #[schemars(range(min = 0, max = 9007199254740991_u64))]
    pub deadline: u64,
    pub task_id: String, pub expected_sequence: String, pub kind: ControlKind,
}
...
pub struct StepAdvanceParams {
    ...
    #[ts(type="number")]
    #[schemars(range(min=0,max=9007199254740991_u64))]
    pub deadline:u64, pub task_id:String, pub expected_sequence:String,
}

#[derive(Clone,Copy,Debug,PartialEq,Serialize,Deserialize,JsonSchema,TS)]
#[serde(rename_all="kebab-case")]
pub enum BrowserOperation { Create, Observe, HandOff, TakeOver, Finish }
...
pub struct BrowserExecuteParams {
    ...
    #[ts(type="number")]
    #[schemars(range(min=0,max=9007199254740991_u64))]
    pub deadline:u64, pub task_id:String, pub expected_sequence:String, pub operation:BrowserOperation,
}
...
pub struct ComputerExecuteParams {
    ...
    #[ts(type="number")]
    #[schemars(range(min=0,max=9007199254740991_u64))]
    pub deadline:u64, pub task_id:String, pub expected_sequence:String, pub tool_name:String,
...
pub struct ComputerStepParams {
    ...
    #[ts(type="number")]
    #[schemars(range(min=0,max=9007199254740991_u64))]
    pub deadline:u64, pub task_id:String, pub expected_sequence:String, pub step_id:String, pub label:String, pub tool_name:String,
    #[ts(type="Record<string, unknown>")]
    pub arguments:serde_json::Value,
}
...
pub enum Request {
    ...
    BrowserExecute { jsonrpc:Version, #[serde(rename="id")] request_id:String, params:BrowserExecuteParams },
    #[serde(rename = "computer.execute")]
    ComputerExecute { jsonrpc:Version, #[serde(rename="id")] request_id:String, params:ComputerExecuteParams },
    #[serde(rename = "computer.step")]
    ComputerStep { jsonrpc:Version, #[serde(rename="id")] request_id:String, params:ComputerStepParams },
    #[serde(rename = "task.cancel")]
    Cancel { jsonrpc: Version, #[serde(rename = "id")] request_id: String, params: CancelParams },
    #[serde(rename = "task.create")]
    Create { jsonrpc: Version, #[serde(rename = "id")] request_id: String, params: CreateParams },
    #[serde(rename = "task.control")]
    Control { jsonrpc: Version, #[serde(rename = "id")] request_id: String, params: ControlParams },
    #[serde(rename = "task.complete")]
    Complete { jsonrpc:Version, #[serde(rename="id")] request_id:String, params:CompleteParams },
    #[serde(rename = "task.fail")]
    Fail { jsonrpc:Version, #[serde(rename="id")] request_id:String, params:CompleteParams },
    #[serde(rename = "task.wait_for_user")]
    WaitForUser { jsonrpc:Version, #[serde(rename="id")] request_id:String, params:WaitForUserParams },
    #[serde(rename = "gateway.hello")]
    Hello { jsonrpc: Version, #[serde(rename = "id")] request_id: String, params: HelloParams },
    #[serde(rename = "task.list")]
    List { jsonrpc: Version, #[serde(rename = "id")] request_id: String, params: ListParams },
    ...
    StepDeclare { jsonrpc: Version, #[serde(rename = "id")] request_id: String, params: StepDeclareParams },
    #[serde(rename = "task.step.get")]
    StepGet { jsonrpc: Version, #[serde(rename = "id")] request_id: String, params: GetParams },
    #[serde(rename = "task.browser.get")]
    BrowserGet { jsonrpc: Version, #[serde(rename = "id")] request_id: String, params: GetParams },
    #[serde(rename = "task.step.advance")]
    StepAdvance { jsonrpc:Version, #[serde(rename="id")] request_id:String, params:StepAdvanceParams },
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, JsonSchema, TS)]
#[serde(deny_unknown_fields)]
pub struct StepDeclaration { pub step_id: String, pub label: String, pub accepted_sequence: String }

#[derive(Clone, Copy, Debug, PartialEq, Serialize, Deserialize, JsonSchema, TS)]
#[serde(rename_all = "kebab-case")]
pub enum AttemptResultPhase { Observed, Unknown }

#[derive(Clone, Copy, Debug, PartialEq, Serialize, Deserialize, JsonSchema, TS)]
#[serde(rename_all = "kebab-case")]
pub enum AttemptUnknownReason { InvalidInput, DependencyUnavailable, WorkerFailed, TimedOut, InvalidResponse, IdentityMismatch, ObserveFailed, UserInput }

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, JsonSchema, TS)]
#[serde(deny_unknown_fields)]
pub struct AttemptResult {
    pub step_id: String, pub attempt_id: String, pub worker_instance_id: String, pub host_session_id: String,
...
pub struct ControlRecord {
    pub attempt_id: String, pub control_id: String, pub kind: ControlKind, pub phase: ControlPhase,
    pub accepted_sequence: String, pub stopped_sequence: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional)]
...
#[derive(Clone,Debug,PartialEq,Serialize,Deserialize,JsonSchema,TS)]
#[serde(deny_unknown_fields)]
pub struct BrowserReference { pub external_task_ref:String, pub ownership:String, pub managed_pages:u16, pub finished:bool, pub updated_sequence:String }
...
pub enum QueryResult {
    Hello { protocol_version: ProtocolVersion, platform: Platform, capabilities: Vec<CapabilityInfo> },
    Tasks { tasks: Vec<TaskSnapshot>, next_after_task_id: Option<String> },
    Snapshot { task: TaskSnapshot },
    Events { task_id: String, events: Vec<TaskEvent> },
    Step { task: TaskSnapshot, step: Option<StepDeclaration> },
    BrowserState { task: TaskSnapshot, reference: Option<BrowserReference> },
    Control { task: TaskSnapshot, control: ControlRecord },
    Browser { task:TaskSnapshot, reference:BrowserReference },
    Computer { task:TaskSnapshot, attempt_result:AttemptResult },
    ComputerStep { task_id:String, status:TaskStatus, sequence:String, action_succeeded:Option<bool>, unknown_reason:Option<AttemptUnknownReason>, observation:Option<ComputerObservation> },
}
...
impl Request {
    pub fn agent_id(&self) -> &str {
        match self { Self::WaitForUser{params,..}=>&params.agent_id, Self::ComputerStep{params,..}=>&params.agent_id, Self::ComputerExecute{params,..}=>&params.agent_id, Self::Complete{params,..}|Self::Fail{params,..}=>&params.agent_id, Self::BrowserExecute{params,..}=>&params.agent_id, Self::StepAdvance{params,..}=>&params.agent_id, Self::Cancel { params, .. } => &params.agent_id, Self::Control { params, .. } => &params.agent_id, Self::Create { params, .. } => &params.agent_id, Self::Get { params, .. } | Self::StepGet { params, .. } | Self::BrowserGet { params, .. } => &params.agent_id, Self::Events { params, .. } => &params.agent_id, Self::List { params, .. } => &params.agent_id, Self::Hello { params, .. } => &params.agent_id, Self::StepDeclare { params, .. } => &params.agent_id }
    }
    pub fn request_id(&self) -> &str {
        match self { Self::WaitForUser{request_id,..}|Self::ComputerStep{request_id,..}|Self::ComputerExecute{request_id,..}|Self::Complete{request_id,..}|Self::Fail{request_id,..}|Self::BrowserExecute{request_id,..}|Self::StepAdvance{request_id,..}|Self::Cancel { request_id, .. } | Self::Control { request_id, .. } | Self::Create { request_id, .. } | Self::Get { request_id, .. } | Self::Events { request_id, .. } | Self::List { request_id, .. } | Self::Hello { request_id, .. } | Self::StepDeclare { request_id, .. } | Self::StepGet { request_id, .. } | Self::BrowserGet { request_id, .. } => request_id }
    }
    ...
    pub fn validate(&self, now_ms: u64) -> Result<(), RpcError> {
        ...
        if capability != if matches!(self,Self::WaitForUser{..}){Capability::TaskWaitForUser}else if matches!(self,Self::ComputerExecute{..}|Self::ComputerStep{..}){Capability::ComputerExecute}else if matches!(self,Self::Complete{..}){Capability::TaskComplete}else if matches!(self,Self::Fail{..}){Capability::TaskFail}else if matches!(self,Self::BrowserExecute{..}){Capability::BrowserExecute}else if matches!(self,Self::StepAdvance{..}){Capability::TaskStepAdvance}else if matches!(self, Self::Create { .. }) { Capability::TaskCreate } else if matches!(self, Self::Cancel { .. }) { Capability::TaskCancel } else if matches!(self, Self::Control { .. }) { Capability::TaskControl } else if matches!(self, Self::StepDeclare { .. }) { Capability::TaskStepDeclare } else { Capability::TaskRead } {
            return Err(RpcError::new(-32602, "请求能力不匹配"));
        }
        let (agent_id, task_id, deadline) = match self {
            Self::WaitForUser{params,..}=>{if sequence(&params.expected_sequence)?==0||params.reason.trim().is_empty()||params.reason.trim().as_bytes().len()>512||params.reason.chars().any(char::is_control){return Err(RpcError::new(-32602,"非法等待原因"));}(&params.agent_id,Some(params.task_id.as_str()),params.deadline)},
            Self::ComputerStep{params,..}=>{if sequence(&params.expected_sequence)?==0||!valid_id(&params.step_id)||!valid_step_label(&params.label)||!valid_sdk_tool_name(&params.tool_name)||!params.arguments.is_object()||!serde_json::to_vec(&params.arguments).is_ok_and(|value|value.len()<=16*1024)||!safe_sdk_arguments(&params.arguments){return Err(RpcError::new(-32602,"非法桌面步骤参数"));}(&params.agent_id,Some(params.task_id.as_str()),params.deadline)},
            Self::ComputerExecute{params,..}=>{if sequence(&params.expected_sequence)?==0||!valid_sdk_tool_name(&params.tool_name)||!params.arguments.is_object()||!serde_json::to_vec(&params.arguments).is_ok_and(|value|value.len()<=16*1024)||!safe_sdk_arguments(&params.arguments){return Err(RpcError::new(-32602,"非法桌面工具参数"));}(&params.agent_id,Some(params.task_id.as_str()),params.deadline)},
            Self::Complete{params,..}=>{if sequence(&params.expected_sequence)?==0{return Err(RpcError::new(-32602,"非法期望序号"));}(&params.agent_id,Some(params.task_id.as_str()),params.deadline)},
            Self::Fail{params,..}=>{if sequence(&params.expected_sequence)?==0{return Err(RpcError::new(-32602,"非法期望序号"));}(&params.agent_id,Some(params.task_id.as_str()),params.deadline)},
            Self::BrowserExecute{params,..}=>{if sequence(&params.expected_sequence)?==0{return Err(RpcError::new(-32602,"非法期望序号"));}(&params.agent_id,Some(params.task_id.as_str()),params.deadline)},
            Self::StepAdvance{params,..}=>{if sequence(&params.expected_sequence)?==0{return Err(RpcError::new(-32602,"非法期望序号"));}(&params.agent_id,Some(params.task_id.as_str()),params.deadline)},
            Self::Cancel { params, .. } => {
                if sequence(&params.expected_sequence)? == 0 { return Err(RpcError::new(-32602, "非法期望序号")); }
            ...
            Self::Create { params, .. } => {
                if !valid_id(&params.idempotency_key) || params.description.trim().is_empty() || params.description.len() > 4096 || params.name.as_deref().is_some_and(|name| !valid_task_name(name)) {
            ...
            Self::List { params, .. } => {
                ...
                (&params.agent_id, params.after_task_id.as_deref(), params.deadline)
            }
            Self::Get { params, .. } => (&params.agent_id, Some(params.task_id.as_str()), params.deadline),
            Self::Events { params, .. } => {
            ...
            Self::StepDeclare { params, .. } => {
                if sequence(&params.expected_sequence)? == 0 || !valid_id(&params.step_id) || !valid_step_label(&params.label) { return Err(RpcError::new(-32602, "非法步骤声明参数")); }
                (&params.agent_id, Some(params.task_id.as_str()), params.deadline)
            },
            Self::StepGet { params, .. } => (&params.agent_id, Some(params.task_id.as_str()), params.deadline),
            Self::BrowserGet { params, .. } => (&params.agent_id, Some(params.task_id.as_str()), params.deadline),
        };
        if !valid_id(self.request_id()) || !valid_id(agent_id) || task_id.is_some_and(|id| !valid_id(id)) || deadline > 9_007_199_254_740_991 {
...
pub fn encode_request(request:&Request)->Result<Vec<u8>,serde_json::Error>{serde_json::to_vec(request)}
pub fn decode_response(bytes:&[u8])->Result<Response,serde_json::Error>{serde_json::from_slice(bytes)}
pub fn encode_agent_request(request:&AgentRequest)->Result<Vec<u8>,serde_json::Error>{serde_json::to_vec(request)}
pub fn decode_agent_request(bytes:&[u8])->Result<AgentRequest,serde_json::Error>{serde_json::from_slice(bytes)}
...
fn valid_sdk_tool_name(value:&str)->bool{!value.is_empty()&&value.len()<=64&&value.bytes().all(|byte|byte.is_ascii_lowercase()||byte.is_ascii_digit()||byte==b'_')}

fn safe_sdk_arguments(value:&serde_json::Value)->bool{
    match value{
        serde_json::Value::Object(fields)=>fields.iter().all(|(key,value)|{
            let normalized=key.bytes().filter(|byte|*byte!=b'_'&&*byte!=b'-').map(|byte|byte.to_ascii_lowercase()).collect::<Vec<_>>();
            !matches!(normalized.as_slice(),b"pid"|b"windowid"|b"session"|b"target"|b"snapshotid"|b"elementtoken"|b"elementindex"|b"workerinstanceid"|b"hostsessionid"|b"screenshotoutfile")&&safe_sdk_arguments(value)
        }),
...
pub fn sdk_arguments_json(value:&serde_json::Value)->Result<String,RpcError>{serde_json::to_string(value).map_err(|_|RpcError::new(-32602,"非法桌面工具参数"))}
...
mod tests {
    ...
    fn query_contract_rejects_invalid_inputs_and_keeps_integer_precision() {
        ...
        let response = Response::Success { jsonrpc: Version::V2, id: "r1".into(), result: QueryResult::Snapshot { task: TaskSnapshot { task_id: "t1".into(), owner_agent_id: "a1".into(), name: None, status: TaskStatus::Interrupted, sequence: "9007199254740993".into() } } };
    ...
    fn computer_bridge_accepts_sdk_arguments_and_rejects_host_identity() {
        ...
        assert!(decode(&serde_json::to_vec(&request(serde_json::json!({"text":"hello","delivery_mode":"background"}))).unwrap()).unwrap().validate(1).is_ok());
        assert!(decode(&serde_json::to_vec(&request(serde_json::json!({"text":"hello","scope":"desktop"}))).unwrap()).unwrap().validate(1).is_ok());
        for arguments in [serde_json::json!({"pid":1}),serde_json::json!({"target":{"window_id":2}}),serde_json::json!({"element_token":"opaque"}),serde_json::json!({"session":"forged"})]{
            assert!(decode(&serde_json::to_vec(&request(arguments)).unwrap()).unwrap().validate(1).is_err());
        }
        ...
        assert!(matches!(decode(&serde_json::to_vec(&step).unwrap()).unwrap(),Request::ComputerStep{..}));
    }
    ...
    fn list_contract_defaults_and_rejects_invalid_pages() {
        ...
        assert!(request.validate(1999).is_ok());
        assert_eq!(request.validate(2000).unwrap_err().code, -32001);
        assert!(matches!(request, Request::List { params: ListParams { after_task_id: None, include_finished: false, running_only: false, .. }, .. }));
        for (field, invalid) in [("limit", serde_json::json!(0)), ("limit", serde_json::json!(101)), ("after_task_id", serde_json::json!("")), ("after_task_id", serde_json::json!("../task"))] {
            let mut changed = value.clone(); changed["params"][field] = invalid;
            assert!(decode(&serde_json::to_vec(&changed).unwrap()).unwrap().validate(0).is_err());
        }
        for (field, invalid) in [("limit", serde_json::json!(256)), ("include_finished", serde_json::json!("true")), ("unexpected", serde_json::json!(true))] {
            let mut changed = value.clone(); changed["params"][field] = invalid;
    ...
    fn hello_contract_rejects_invalid_versions() {
        ...
        assert!(decode(&serde_json::to_vec(&value).unwrap()).unwrap().validate(1999).is_ok());
        for version in [serde_json::json!({"major":-1,"minor":0}), serde_json::json!({"major":1,"minor":65536}), serde_json::json!({"major":1}), serde_json::json!({"major":1,"minor":0,"extra":true}), serde_json::Value::Null] {
            let mut changed = value.clone(); changed["params"]["protocol_version"] = version;
            assert!(decode(&serde_json::to_vec(&changed).unwrap()).is_err());
        }
    ...
    fn step_contract_is_strict_and_bounded() {
        ...
        assert!(decode(&serde_json::to_vec(&value).unwrap()).unwrap().validate(1999).is_ok());
        for (field, invalid) in [("expected_sequence",serde_json::json!("0")),("step_id",serde_json::json!("../bad")),("label",serde_json::json!(" ")),("label",serde_json::json!("a\n")),("label",serde_json::json!("龙".repeat(86)))] {
            let mut changed=value.clone(); changed["params"][field]=invalid;
            assert!(decode(&serde_json::to_vec(&changed).unwrap()).unwrap().validate(0).is_err());
        }
        let mut extra=value; extra["params"]["action"]=serde_json::json!("click");
        assert!(decode(&serde_json::to_vec(&extra).unwrap()).is_err());
    }
